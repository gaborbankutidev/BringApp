...
function my_theme_register_required_plugins() {
	...
	$plugins = [
		...
		[
			...
			"source" =>
				get_stylesheet_directory() . "/lib/plugins/tgm-example-plugin.zip", // The plugin source.
		...
		[
			...
			"required" => true, // If false, the plugin is only 'recommended' instead of required.
			"external_url" =>
				"https://github.com/thomasgriffin/New-Media-Image-Uploader", // If set, overrides default API URL and points to an external URL.
		],
		...
		[
			...
			"source" =>
				"https://github.com/jrfnl/WP-adminbar-comments-to-pending/archive/master.zip",
		],
