...
export const markdownInlineElements = [
	"p",
	"a",
	"em",
	"strong",
...
type MarkdownInlineProps = (
	...
	elementsClassName?: {[key in MarkdownInlineElements]?: string};
	className?: string;
};

export const getInlineComponents = (elementsClassName: {
	[key in MarkdownInlineElements]?: string;
}) => {
	return {
		// p
...
const MarkdownInline = ({
	...
	const components = useMemo(
		() => getInlineComponents(elementsClassName),
