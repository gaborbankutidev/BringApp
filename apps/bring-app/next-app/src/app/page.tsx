	...
	return (
		<>
			...
			<p className="mb-6 text-gray-200">
				...
				WordPress as a headless CMS and site builder. It provides a set of tools and components to
				help you get started quickly and build your app with ease.
			</p>
			...
			<div className="mb-8 flex flex-col gap-4 md:mb-24 xl:flex-row">
				...
				<Link
					...
					className={twJoin(
						...
						(wpStatus === "error" || wpStatus === "unavailable") && "pointer-events-none opacity-40"
					)}
				>
					{wpStatus === "ok"
			...
			{errorNotice && (
				<div className="flex min-h-[180px] items-center rounded-lg border border-gray-500/60 border-red-600 bg-gray-800/60 px-4 py-8">
					<div>
